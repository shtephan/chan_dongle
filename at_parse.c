...
static const char * parse_cmgr_text(char ** str, size_t len, char * oa, size_t oa_len, str_encoding_t * oa_enc, char ** msg, str_encoding_t * msg_enc, int* msg_ref, int* msg_parts, int* msg_part)
{
	/*
		...
		int* msg_ref, int* msg_parts, int* msg_part)
{
	...
	*str += 6;
	...
	if(len > 0)
	{
		...
		const char* (*fptr)(char** str, size_t len, char* num, size_t num_len, str_encoding_t * oa_enc, char** msg, str_encoding_t * msg_enc, int* msg_ref, int* msg_parts, int* msg_part);
